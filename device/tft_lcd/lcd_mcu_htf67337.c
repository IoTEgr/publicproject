...
BEGIN_INIT_TAB
// DLAY(120), 
// hal_dacHPSet(0,HP_VDD_2_8V);
// add by song.
CMD( 0x11), DLAY(120),
CMD( 0xfe), CMD( 0xef), CMD( 0x36), DAT( 0x48),CMD( 0x3a), DAT( 0x05),
CMD( 0x86), DAT( 0x98),CMD( 0x89), DAT( 0x13),CMD( 0x8b), DAT( 0x80),CMD( 0x8d), DAT( 0x33),CMD( 0x8e), DAT( 0x0f),
CMD( 0xe8), DAT( 0x13),DAT( 0x00),
CMD( 0xec), DAT( 0x33),DAT( 0x07),DAT( 0x44),
CMD( 0xff), DAT( 0x62),
CMD( 0x99), DAT( 0x3e),CMD( 0x9d), DAT( 0x4b),CMD( 0x98), DAT( 0x3e),CMD( 0x9c), DAT( 0x4b),CMD( 0xc3), DAT( 0x40),CMD( 0xc4), DAT( 0x68),CMD( 0xc9), DAT( 0x1B),
///gamma
CMD( 0xF0), DAT( 0x11),DAT( 0x11),DAT( 0x08),DAT( 0x06),DAT( 0xF2),DAT( 0x20),
CMD( 0xF1), DAT( 0x2E),DAT( 0x82),DAT( 0x80),DAT( 0x10),DAT( 0x12),DAT( 0x2f),
CMD( 0xF2), DAT( 0x11),DAT( 0x11),DAT( 0x08),DAT( 0x06),DAT( 0xF2),DAT( 0x20),
CMD( 0xF3), DAT( 0x2E),DAT( 0x82),DAT( 0x80),DAT( 0x10),DAT( 0x12),DAT( 0x2f),
CMD( 0x35), DAT( 0x00),CMD( 0x44), DAT( 0x00),DAT( 0x0a),CMD( 0x11), DLAY(120),CMD( 0x29),CMD( 0x2c),
...
LCD_OP_SECTION lcddev_t st7789v = 
{
    ...
    #if LX_BOARD_SELECT == LX_D003_BOARD || LX_BOARD_SELECT == LX_D002_BOARD || LX_BOARD_SELECT == LX_D006_BOARD
    .scan_mode = LCD_ROTATE_90,     //rotate 90
    #elif LX_BOARD_SELECT == LX_D004_BOARD || LX_BOARD_SELECT == LX_D005_BOARD || LX_BOARD_SELECT == LX_A100_BOARD || LX_BOARD_SELECT == LX_D001_BOARD || LX_BOARD_SELECT == YCST_D133_BOARD
    .scan_mode = LCD_ROTATE_270,     //rotate 270 设置旋转角度
    #elif LX_BOARD_SELECT == LX_K2T_TC_BOARD
    .scan_mode = LCD_ROTATE_90,
    #else
	.scan_mode = LCD_ROTATE_270,     //rotate 90 设置旋转角度
	#endif
