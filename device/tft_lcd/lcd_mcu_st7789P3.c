...
CMD(0x11),
    ...
    CMD(0x3A), // RGB 5-6-5-bit
    DAT(0x05),

    CMD(0xB7), // Gate Control
    DAT(0x06),

    CMD(0xBB), // Power control
    DAT(0x20),
    ...
    CMD(0xC3), // VRH Set
    DAT(0x13), // 4.3+( vcom+vcom offset+vdv)
    ...
    DAT(0xA7), // High power mode

    CMD(0xD0), // Power Control 1
    DAT(0xA4), // Normal mode
    DAT(0xA1),

    CMD(0xD6), // Gate Output Selection in Sleep In Mode
    DAT(0xA1),

    CMD(0xE0), // gamma setting
    DAT(0xF0),
    DAT(0x06),
    DAT(0x0E),
    DAT(0x08),
